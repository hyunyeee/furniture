...
export const ToggleSwitch = ({
  ...
  return (
    <label className="flex w-full cursor-pointer justify-center">
      ...
      />
      <div
        className={`relative h-7 w-14 rounded-full transition-colors peer-focus:outline-none ${isCorporation ? "bg-btn-green" : "bg-gray-600"}`}
      >
        <div
      ...
      <span
        className={`ms-3 text-lg font-semibold ${isCorporation ? "text-btn-green" : "text-gray-600"} `}
      >
